...
export default function LoginClient() {
  ...
  // Replaces react-router's `location.state.redirectTo` — Next.js has no
  // location-state passing mechanism, so the pages that redirect here encode
  // the return path as a `?redirectTo=` query param instead (see migration
  // plan §4).
