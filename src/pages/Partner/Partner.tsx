  ...
  return (
    <main className={styles.page}>
      <SEO
        ...
        description="MessMeals Admin is a powerful app for mess owners to manage menus, customers, orders, delivery partners and business performance - all in one place."
        url="/partner"
      />
