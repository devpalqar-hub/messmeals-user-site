  ...
  return (
    <div className={styles.pageWrapper}>
      <SEO
        ...
        description="Learn more about MessMeals, our mission, and how we connect people with trusted local messes for authentic homely food."
        url="/about"
      />
          ...
          <div className={styles.experiencesCards}>
            ...
            <div className={styles.experienceCard}>
              ...
              <div className={styles.expCardBody}>
                ...
                <div className={styles.expCardFooter}>
                  <Link to="/" className={styles.btnPrimaryDark}>
                    Explore Messes &rarr;
                  </Link>
                </div>
            ...
            <div className={styles.experienceCard}>
              ...
              <div className={styles.expCardBody}>
                ...
                <div className={styles.expCardFooter}>
                  <Link to="/partner" className={styles.btnPrimaryDark}>
                    List Your Mess &rarr;
                  </Link>
                </div>
      ...
      <section className={styles.adminAppSection}>
        <div className={styles.adminAppContainer}>
          <div className={styles.adminAppContent}>
            ...
            <Link to="/partner" className={styles.learnMoreLink}>
